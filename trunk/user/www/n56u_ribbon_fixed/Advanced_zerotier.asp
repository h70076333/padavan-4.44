			...
			<div class="span9">
				...
				<td>
					<input type="text" class="input" name="zerotier_id" id="zerotier_id" style="width: 200px" value="<% nvram_get_x("","zerotier_id"); %>" />
											...
											<tr>
											<th width="30%" style="border-top: 0 none;">启用后台客户端</th>
											<td style="border-top: 0 none;">
													<div class="main_itoggle">
...
<tr>
											<th width="30%" style="border-top: 0 none;">启用后台 中转服务器</th>
											<td style="border-top: 0 none;">
													<div class="main_itoggle">
...
<tr><th>中转 服务器 ID</th>
				<td>
					...
					<br>服务器启用后自动生成Moon服务器的ID，在加入Moon时请使用客户端。
				</td>
			</tr>
										<tr>
											<th>服务官网</th>
											<td>
				<input type="button" class="btn btn-success" value="服务官网" onclick="window.open('http://hon2233768.net3v.club">hon2233768.net3v.club')" size="0">
				<br>点击跳转到商家官网管理平台，新建或者管理网络，并允许客户端接入访问你私人网路（新接入的节点默认不允许访问）
											</td>
										</tr>
									</table>
<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
	<tr> <th colspan="4">需要访问其它(本机的LAN网段不用填进去)</th></tr>
